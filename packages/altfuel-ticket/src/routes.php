...
// Route::get('/crm/comments/sync-sample', [AddTicketCommentController::class, 'syncCommentsSample'])->name('crm.comments.sync_sample');
Route::get('/crm/attachments/sync', [AddTicketCommentAttachmentController::class, 'syncAllAttachments'])->name('crm.attachments.sync');