...
namespace CourseRegistrationLite\Jobs;
...
class SendWorkshopRegistrationSmsJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach (config('course-registration-lite.notify_numbers', []) as $number) {
