...
@section('title', 'لیست ثبت‌نام کارگاه‌ها')
        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a
                        href="{{ route('admin.workshop-registrations.export', array_merge(request()->except(['page']), ['sort' => $currentSort, 'direction' => $currentDirection])) }}"
                        ...
                        <thead>
                            <tr>
                                @foreach ($sortableColumns as $column => $label)
                                    ...
                                    @endphp
                                    <th>
                                        <a href="{{ route('admin.workshop-registrations.index', $query) }}"
